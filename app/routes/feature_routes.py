...
from app.controllers.feature_controller import translate_text, save_translation_history, get_user_history, delete_history_item
...
def delete_history(item_id: str, user_id: str):
    # We accept user_id as a query param for simplicity in this prototype
